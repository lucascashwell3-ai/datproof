...
Built by **Lucas Cashwell** — IT auditor (financial services, SOX) building verification tooling for digital-asset treasuries. DATproof applies next-generation audit practices to the newest thing on corporate balance sheets: existence, valuation, and completeness assertions for digital asset treasuries.
